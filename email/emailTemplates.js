const createWelcomeTemplates = (fullName, clientUrl) => {
  ...
  <html lang="en">
    <head>
      ...
      <title>Welcome to Royal Shades Autos</title>
    </head>
    <body
      style="
    ...
    >
      <main style="border: 1px solid #333; border-radius: 10px">
        ...
        >
          ...
          <p>Best regards,<br />Royal Shades</p>
        </div>
      </main>
    </body>
  </html>
    ...
    >
      ...
      >
        ...
        <div
          ...
          "
        >
          <h1>You have requested for a password reset from Royal Shades</h1>
